// StoreInfo — showroom info + trust badges only (no delivery — that's in checkout)
export default function StoreInfo() {
  const waLink = "https://wa.me/201000000000?text=مرحبا%20HamedoSport%2C%20محتاج%20مساعدة";
  ...
  return (
    <div className="si-wrap container">
      ...
      <div className="si-section-label fu">
        ...
        <span>WHY HAMEDOSPORT</span>
        <div className="si-label-line"/>
      </div>

      {/* ── SPLIT: Store + Hours/Help ── */}
      <div className="si-top fu d2">
        ...
        <div className="si-store-card">
          ...
          <p className="si-store-addr">
            Khub — Shebin El Kom<br/>
            Menofia Governorate, Egypt
          </p>
          <p className="si-store-desc">
            Swing a racket before you buy it. Our staff are players — they'll match you to the right gear for your level and court style.
          </p>
        ...
        <div className="si-right-panel">
          ...
          <div className="si-hours-block">
            <div className="si-block-tag">OPEN HOURS</div>
            <div className="si-hours-row">
              <div className="si-hours-live">
                <div className="si-live-dot"/>
                Open today
              </div>
              <div className="si-hours-time">Sat – Fri</div>
            </div>
            <div className="si-hours-big">6:00 PM – 12:00 AM</div>
          ...
          <div className="si-help-block">
            ...
            <p className="si-help-desc">
              Send us a message and a real player on our team will point you in the right direction — no bots.
            </p>
      ...
      <div className="si-trust-strip fu d3">
        {[
          ...
          { icon: "⬡", title: "Covered for 6 Months", desc: "Every racket and pair of shoes carries full manufacturer warranty." },
